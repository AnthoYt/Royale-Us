...
namespace Royale Us.Modules
{
    ...
    public static class AntiCheat//Référez-vous simplement à certains codes EAC (
    {
        ...
        public static bool RpcSafe(PlayerControl pc, byte callId, MessageReader reader)
        {
            ...
            try
            {
                ...
                switch (rpc)
                {
                    case RpcCalls.StartMeeting:
                        ...
                        {
                            Royale UsPlugin.Logger.LogError($"The meeting has been initiated three times in a short period of time, which is impossible. Refusal,The Rpc requesters identified this time are:{pc.Data.PlayerName}");
                            return true;
                        }
                        break;
                    case RpcCalls.MurderPlayer:
                        ...
                        {
                            Royale UsPlugin.Logger.LogError($"Received an unexpected kill request, which has been rejected. Sender:{pc.Data.PlayerName}");
                            return true;
                        }
                        break;
            ...
            {
                Royale UsPlugin.Logger.LogError("Error in " + e);
            }
            return false;
        }
    }
